...
const Contact = () => {
  ...
  return (
    <section id="contact" ref={ref} style={{ padding: "110px 7%", background: "#050508", position: "relative", overflow: "hidden" }}>
      ...
      >
        ...
        <h2 className="bebas" style={{ fontSize: "clamp(40px, 5vw, 72px)", lineHeight: 1.05, marginBottom: 20 }}>
          READY TO CREATE SOMETHING <span style={{ background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>CINEMATIC?</span>
        </h2>
